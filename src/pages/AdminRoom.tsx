...
//  const { user } = useAuth();
  ...
  async function handleHighlightQuestionAswered (questionId: string) {
    await database.ref(`rooms/${roomId}/questions/${questionId}`).update({
      isHighlighted: true,
    });
  }
          ...
          {questions.map( question =>{
            ...
            <Question
              ...
              <>
                ...
                >
                  <img src={checkImg} alt="Marcar question como respondida" />
                </button>


                <button
                  type='button'
                  onClick={() => handleHighlightQuestionAswered(question.id)}
                >
